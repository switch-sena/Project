...
namespace ConsumeMicroservices.Controllers
{
    public class ModalidadesController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            List<Modalidades> EmpInfo = new List<Modalidades>();
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(apiUrl);
                client.DefaultRequestHeaders.Clear();
                client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", bearerToken);
                HttpResponseMessage Res = await client.GetAsync("api/Modalidades/GetModalidades");
                if (Res.IsSuccessStatusCode)
                {
                    var EmpResponse = Res.Content.ReadAsStringAsync().Result;
                    EmpInfo = JsonConvert.DeserializeObject<List<Modalidades>>(EmpResponse);
                }
            }
        ...
        public async Task<ActionResult> Delete(int id)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                client.DefaultRequestHeaders.Clear();
                client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", bearerToken);
                HttpResponseMessage Res = await client.DeleteAsync("api/Modalidades/DeleteModalidades/" + id);
                if (Res.IsSuccessStatusCode)
                {
        ...
        public async Task<ActionResult> Create(Modalidades modalidades)
        {
            try
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    HttpResponseMessage Res = await client.PostAsync("api/Modalidades/PostModalidades", content);
